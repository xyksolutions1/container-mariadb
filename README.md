...
Example:
`ghcr.io/nfrastack/container-replace:10.6` or optionally

`ghcr.io/nfrastack/container-replace:10.6-1.0` or optionally

`ghcr.io/nfrastack/container-replace:10.6-1.0-alpine` or optinally
