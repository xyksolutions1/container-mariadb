...
Example:
`ghcr.io/nfrastack/container-replace:11.4` or optionally

`ghcr.io/nfrastack/container-replace:11.4-1.0` or optionally

`ghcr.io/nfrastack/container-replace:11.4-1.0-alpine` or optionally
