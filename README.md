...
Example:
`ghcr.io/nfrastack/container-mariadb:11.4` or optionally

`ghcr.io/nfrastack/container-mariadb:11.4-1.0` or optionally

`ghcr.io/nfrastack/container-mariadb:11.4-1.0-alpine` or optinally


- The `branch` will relate to the MAJOR eg `11` and MINOR `.4` release.
